...
namespace Cappario
{
    public class BackendMenu
    {
        ...
        public WebElements RentalMenuButton => new(Driver, By.CssSelector("#voceMenu_rentals.level_1")); 
        ...
        public WebElements ConfirmClosingAllTabsButton => new(Driver, By.CssSelector(".bootbox-accept"));
